...
class EditRequest extends StatefulWidget {  
  ...
  final fromAddress;
  final toAddress;
  EditRequest (this.body, this.title,this.reqID,this.timerange,this.minPr,this.maxPr,this.timeUnit,this.fromAddress,this.toAddress);// this.id,this.timerange,this.minPr,this.maxPr/* this.from ,this.to*/ );
...
class _EditRequestState extends State<EditRequest>{
  ...
  final TextEditingController _timeUnitsTextEditingController= TextEditingController();
  final TextEditingController _fromAddressTextEditingController= TextEditingController();
  final TextEditingController _toAddressTextEditingController= TextEditingController();
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar:  AppBar(
      toolbarHeight: 60,
      title:const Text('Edit request', style: TextStyle(color: Colors.black , fontSize: 40 ,fontWeight: FontWeight.bold),),
  ...
  return SingleChildScrollView(
   child: Column(
    ...
    child: Padding(
      ...
      child: Container(
        ...
        child: Padding(
          padding: const EdgeInsets.all(10),
          child: CustomInputTextFieldWidget(hintText: "${widget.title}",
    ...
    child: Padding(
      ...
      child: Container(
        ...
        child: Padding(
          padding: const EdgeInsets.all(10),
          child: CustomInputTextFieldWidget(hintText: "${widget.body}",
       ...
       child:Padding(   //min
         ...
         child: Container( 
             ...
             child: Padding(
               ...
               child: CustomInputTextFieldWidget(hintText: "min : ${widget.minPr}",
     ...
     SizedBox( // price max
       ...
       child:Padding(   //max
         ...
         child: Container( 
            ...
            child: Padding(
              padding: const EdgeInsets.only( right: 10, left: 10 , bottom: 9),
              child: CustomInputTextFieldWidget(hintText: "max : ${widget.maxPr}",
     ...
     Padding( 
         ...
         child: Center(
           child: Container( 
              ...
              child: Padding(
                padding: const EdgeInsets.only( right: 10, left: 10 , bottom: 9),
                child: CustomInputTextFieldWidget(hintText: "Time : ${widget.timerange}",
     ...
     SizedBox( // time unit
       ...
       child:Padding(   //max
         ...
         child: Container( 
                ...
                child: Padding(
                  padding: const EdgeInsets.only( right: 10, left: 10 , bottom: 9),
                  child: CustomInputTextFieldWidget(hintText: "unit : ${widget.timeUnit}",
                  secure: false,ccontroller: _timeUnitsTextEditingController, 
                  ),
                ),
              ),
            ),
    ...
    child: Padding(
      ...
      child: Container(
        ...
        child: Padding(
          padding: const EdgeInsets.all(10),
          child: CustomInputTextFieldWidget(hintText: "from : [${widget.fromAddress}]   it will replaced by google places data",
          secure: false,ccontroller: _fromAddressTextEditingController, 
          icon: Icons.update,),
        ),
       ),
     ),
    ...
    child: Padding(
      ...
      child: Container(
        ...
        child: Padding(
          padding: const EdgeInsets.all(10),
          child: CustomInputTextFieldWidget(hintText: "To : [${widget.toAddress}]\t\t\t\t\t\t\t\t\tit will replaced by google places data",
          secure: false,ccontroller: _toAddressTextEditingController, 
        ),
       ),
      ),
     ),
   ...
   /// end of UI address never forgett to git me key
    ...
    child: Container(
      ...
      child: FlatButton(onPressed: () async{//Calling editRequest() function
          print("From LatLong after Edit: latlng(${globals.fromLat},${globals.fromLong})");
          print("=======================================================================");
          print("To LatLong after Edit: latlng(${globals.toLat},${globals.toLong})");
      ...
      child: const Center(
      child: Text("   Edit  " , style: TextStyle(color:Colors.white, fontWeight: FontWeight.bold, fontSize:25,),),
         ),
        ),
       ),
      color: primaryColor,
