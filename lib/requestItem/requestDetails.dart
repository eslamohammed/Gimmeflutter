   ...
   return Scaffold(
      ...
      actions:[
        TextButton(
          ...
          child: const Text("Edit",style:TextStyle( color: primaryColor ,fontWeight: FontWeight.bold,fontSize:25) ,)
        ),
      ],
     ...
     floatingActionButton: FloatingActionButton(//delete function
        onPressed: () {
          //calling delete function to delete request
          RequestItem().deleteRequest(context,reqID); //sending object id to be deleted
  ...
  Widget viewGMapLocation(BuildContext context, double lat ,double lng ){
    return GoogleMap(
       initialCameraPosition:
        CameraPosition(
         target: LatLng(lat, lng), //LatLng(currentLatLocation(), currentLngLocation()) , //LatLng(30.033333, 31.233334),
         zoom: 11.0,),    //lag $$ long
