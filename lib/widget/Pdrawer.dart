...
return Drawer(
  ...
  children:[
    buildHeader(
      ...
      name: name,
      email: email, 
      onClicked: ()=> Navigator.push(context, MaterialPageRoute(builder: (context)=> ProfilePages()
      )
     ),
    ),
    ...
    text : 'profile page',
    icon : Icons.people,
    onCliced: ()=> Navigator.push(context, MaterialPageRoute(builder: (context)=>ProfilePages())),
    ),
    ...
    */
    ListTile(
    leading : Icon(Icons.logout , color:  Color.fromARGB(255, 10, 86, 114),),
    title: Text('LogOut' , style: const TextStyle(color: Color.fromARGB(255, 10, 86, 114)),),
